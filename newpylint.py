...
import tempfile
import os
import ollama   # pip install ollama, pylint


def generate_code(prompt, model="codellama:7b"):
...
def simple_framework(code_prompt, test_prompt, model="codellama:7b"):
...
if __name__ == "__main__":
    simple_framework(
        ...
        model="codellama:7b"   # change to your model name from `ollama list`
    )
